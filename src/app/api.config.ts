...
export class ApiConfig {
    ...
    public static getApiUrl() {
        return "http://cmsdev.helpfooter.com/alucard263096/phamacy/api/";
    }
    public static getUploadPath() {
        return "http://cmsdev.helpfooter.com/alucard263096/phamacy/upload/";
    }
    public static getFileUploadAPI() {
        return "http://cmsdev.helpfooter.com/alucard263096/phamacy/fileupload";
    }
    public static getDataBaseName() {
        return "alucard263096_phamacy.db";
    }
